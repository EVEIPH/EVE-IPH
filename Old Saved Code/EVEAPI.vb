...
'    Public Function GetCharacterSheet(ByVal APIKey As SavedTokenData) As CharacterSheet
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
'        Dim m_node As XmlNode
...
'    Public Function GetCharacterStandings(ByVal APIKey As SavedTokenData) As NPCStandings
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
'        Dim m_node As XmlNode
...
'    Public Function GetIndustryJobs(ByVal SentKey As SavedTokenData, ByVal ScanType As ScanType, ByRef CachedUntilDate As Date) As List(Of IndustryJob)
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
'        Dim m_node As XmlNode
...
'    Public Function GetCorpFacilities(ByVal SentKey As SavedTokenData, ByRef CachedUntilDate As Date) As List(Of CorpFacility)
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
'        Dim m_node As XmlNode
...
'    Public Function GetCurrentResearchAgents(ByVal SentKey As SavedTokenData, ByRef CacheDate As Date) As List(Of CurrentResearchAgent)
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
'        Dim m_node As XmlNode
...
'    Public Function GetAssets(ByVal SentKey As SavedTokenData, ByVal ScanType As ScanType, ByRef CacheDate As Date) As List(Of EVEAsset)
'        ' XML Variables
'        Dim m_xmld As XmlDocument
'        Dim m_nodelist As XmlNodeList
...
'    Public Function GetBlueprints(ByVal SentKey As SavedTokenData, ByVal ScanType As ScanType, ByRef CacheDate As Date) As List(Of EVEBlueprint)
'        '<eveapi version="2">
